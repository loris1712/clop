    ...
    return (
        <div className={styles.card}>
            <div className={styles.cardInner}>
                <div className={type === 'vip' ? styles.cardFrontVip : styles.cardFront}>
                    <div className={styles.frontContent}>
                        ...
                        <p className={styles.vipPass}>Fidelity Card</p>
                        <h2 className={styles.cardTitle}>{nickname}</h2>
                        {/* Numero di serie */}
                        <img src="./logo.svg" alt="Logo" className={styles.logoFront} />

                        {/* Icona segnale (personalizzata) */}
                        <div style={{ width: '16px', height: '16px', position: 'absolute', bottom: '0%', left: '0' }}>
                        ...
                        <div>
                        <p className={styles.serialNumber}>F45H10N P4RTY 5AL3RN0</p>
            ...
            <div className={styles.pedestal}>
                <div className={type === 'vip' ? styles.stepBottomVip : styles.stepBottom}></div>
                <div className={type === 'vip' ? styles.stepTopVip : styles.stepTop}></div>
            </div>
        </div>
    );
};
